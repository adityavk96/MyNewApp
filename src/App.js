...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {isMenuOpen && (
        <div onClick={toggleMenu} className="fixed inset-0 bg-blue opacity-50 z-30 lg:hidden" />
      )}
      <div className={`flex flex-col transition-all duration-300 ease-in-out ${isMenuOpen ? 'pl-64' : 'pl-0'}`}>
